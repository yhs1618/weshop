...
public class CartCheckoutDTO {
    ...
    public CartCheckoutDTO setActualPrice(BigDecimal actualPrice) {
    ...
    public CartCheckoutDTO setCheckedAddress(CheckedAddressVO checkedAddress) {
    ...
    public CartCheckoutDTO setCheckedCoupon(UserCoupon checkedCoupon) {
    ...
    public CartCheckoutDTO setCouponList(List<UserCoupon> couponList) {
    ...
    public CartCheckoutDTO setCheckedGoodsList(List<Cart> checkedGoodsList) {
    ...
    public CartCheckoutDTO setCouponPrice(BigDecimal couponPrice) {
    ...
    public CartCheckoutDTO setFreightPrice(BigDecimal freightPrice) {
    ...
    public CartCheckoutDTO setGoodsTotalPrice(BigDecimal goodsTotalPrice) {
    ...
    public CartCheckoutDTO setOrderTotalPrice(BigDecimal orderTotalPrice) {
