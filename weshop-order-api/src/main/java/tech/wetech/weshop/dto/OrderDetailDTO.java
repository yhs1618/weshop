...
public class OrderDetailDTO {
    ...
    public OrderDetailDTO(OrderInfoVO orderInfo, List<OrderGoods> orderGoods, HandleOptionDTO handleOption) {
    ...
    public OrderDetailDTO setOrderInfo(OrderInfoVO orderInfo) {
        this.orderInfo = orderInfo;
        return this;
    }
    ...
    public OrderDetailDTO setHandleOption(HandleOptionDTO handleOption) {
        this.handleOption = handleOption;
        return this;
    }
}
