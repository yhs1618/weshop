...
public class HandleOptionDTO {
    ...
    public HandleOptionDTO setBuy(boolean buy) {
        this.buy = buy;
        return this;
    }
    ...
    public HandleOptionDTO setCancel(boolean cancel) {
        this.cancel = cancel;
        return this;
    }
    ...
    public HandleOptionDTO setComment(boolean comment) {
    ...
    public HandleOptionDTO setConfirm(boolean confirm) {
    ...
    public HandleOptionDTO setDelete(boolean delete) {
        this.delete = delete;
        return this;
    }
    ...
    public HandleOptionDTO setDelivery(boolean delivery) {
    ...
    public HandleOptionDTO setPay(boolean pay) {
        this.pay = pay;
        return this;
    }
    ...
    public HandleOptionDTO setReturn(boolean aReturn) {
        isReturn = aReturn;
        return this;
    }
}
